...
const resolvedUrl=(value:string|undefined,fallback:string)=>value===undefined?fallback:value.trim();
...
export function createModules(env:ModuleEnvironment={}):FoodLabModule[]{
  const configured:FoodLabModule[]=[
    {
      ...
      localUrl:resolvedUrl(env.VITE_PRODUCT_DEVELOPMENT_URL,'http://localhost:5174'),productionUrl:'',repositoryPath:'../Food_Product_Development_AI',
    ...
    },
    {
      ...
      localUrl:resolvedUrl(env.VITE_SENSORY_URL,'http://localhost:5175'),productionUrl:'',repositoryPath:'../Food_Sensory_AI',
    ...
    },
    {
      ...
      localUrl:resolvedUrl(env.VITE_SHELF_LIFE_URL,'http://localhost:5176'),productionUrl:'',repositoryPath:'../Food_Shelf_Life_Predictor',
    ...
    },
    {
      ...
      localUrl:resolvedUrl(env.VITE_QA_URL,'http://localhost:5177'),productionUrl:'',repositoryPath:'../Food_QA_Dashboard',
...
export const modules=createModules(import.meta.env);
