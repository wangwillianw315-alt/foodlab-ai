...
export function SiteLayout(){const[open,setOpen]=useState(false);return <div className="site-shell">
  ...
  <footer><div><div><strong>FoodLab AI</strong><p>A modular food science portfolio platform.</p></div><div className="footer-note">Educational and research-planning use only · © 2026 Tianyi Wang</div></div></footer>
 </div>}
